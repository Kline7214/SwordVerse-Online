...
public class SocialMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SocialMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(SwordverseOnlineModMenus.SOCIAL.get(), id);
