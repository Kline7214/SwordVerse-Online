...
public class SettingsMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SettingsMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(SwordverseOnlineModMenus.SETTINGS.get(), id);
