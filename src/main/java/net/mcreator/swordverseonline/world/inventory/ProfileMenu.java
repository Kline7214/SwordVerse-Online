...
public class ProfileMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ProfileMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(SwordverseOnlineModMenus.PROFILE.get(), id);
