 ...
 *
 */
package net.mcreator.swordverseonline;
...
import net.mcreator.swordverseonline.init.SwordverseOnlineModBlocks;
...
@Mod("swordverse_online")
public class SwordverseOnlineMod {
	public static final Logger LOGGER = LogManager.getLogger(SwordverseOnlineMod.class);
	public static final String MODID = "swordverse_online";
	...
	public SwordverseOnlineMod() {
		...
		SwordverseOnlineModMenus.REGISTRY.register(bus);
