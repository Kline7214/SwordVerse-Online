...
public class InterfaceProfileScreen extends AbstractContainerScreen<InterfaceProfileMenu> {
	private final static HashMap<String, Object> guistate = InterfaceProfileMenu.guistate;
	...
	ImageButton imagebutton_equiptment_button;
	ImageButton imagebutton_item_button;
	ImageButton imagebutton_skills_button;

	public InterfaceProfileScreen(InterfaceProfileMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("swordverse_online:textures/screens/interface_profile.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.swordverse_online.interface_profile.label_lv"), -148, 14, -12829636);
		...
		this.font.draw(poseStack, Component.translatable("gui.swordverse_online.interface_profile.label_hp"), -148, 25, -12829636);
		this.font.draw(poseStack,

				RenderSTGProcedure.execute(entity), -58, 35, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.swordverse_online.interface_profile.label_str"), -148, 35, -12829636);
		this.font.draw(poseStack,

				RenderSPDProcedure.execute(entity), -58, 45, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.swordverse_online.interface_profile.label_spd"), -148, 45, -12829636);
		this.font.draw(poseStack,

				RenderMPProcedure.execute(entity), -58, 55, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.swordverse_online.interface_profile.label_mp"), -148, 55, -12829636);
		this.font.draw(poseStack,

				RenderPlayerNameProcedure.execute(world, x, y, z, entity), -129, -117, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.swordverse_online.interface_profile.label_item"), 34, -65, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.swordverse_online.interface_profile.label_equipment"), 34, -47, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.swordverse_online.interface_profile.label_skills"), 34, -29, -12829636);
	}
	...
	public void init() {
		...
		imagebutton_equiptment_button = new ImageButton(this.leftPos + 16, this.topPos + -52, 82, 18, 0, 0, 18, new ResourceLocation("swordverse_online:textures/screens/atlas/imagebutton_equiptment_button.png"), 82, 36, e -> {
		});
		guistate.put("button:imagebutton_equiptment_button", imagebutton_equiptment_button);
		this.addRenderableWidget(imagebutton_equiptment_button);
		imagebutton_item_button = new ImageButton(this.leftPos + 16, this.topPos + -70, 82, 18, 0, 0, 18, new ResourceLocation("swordverse_online:textures/screens/atlas/imagebutton_item_button.png"), 82, 36, e -> {
		});
		guistate.put("button:imagebutton_item_button", imagebutton_item_button);
		this.addRenderableWidget(imagebutton_item_button);
		imagebutton_skills_button = new ImageButton(this.leftPos + 16, this.topPos + -34, 82, 18, 0, 0, 18, new ResourceLocation("swordverse_online:textures/screens/atlas/imagebutton_skills_button.png"), 82, 36, e -> {
		});
