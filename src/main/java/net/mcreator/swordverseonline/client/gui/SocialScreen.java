...
public class SocialScreen extends AbstractContainerScreen<SocialMenu> {
	private final static HashMap<String, Object> guistate = SocialMenu.guistate;
	...
	ImageButton imagebutton_party_button;
	ImageButton imagebutton_friends_button;
	ImageButton imagebutton_guild_button;

	public SocialScreen(SocialMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("swordverse_online:textures/screens/social.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.swordverse_online.social.label_stg"), -159, 46, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.swordverse_online.social.label_spd"), -159, 56, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.swordverse_online.social.label_mp"), -159, 66, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.swordverse_online.social.label_hp"), -159, 76, -12829636);
		this.font.draw(poseStack,

				RenderPlayerNameProcedure.execute(world, x, y, z, entity), -140, -103, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.swordverse_online.social.label_lv"), -159, 27, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.swordverse_online.social.label_exp"), -159, 36, -12829636);
		this.font.draw(poseStack,
		...
		this.font.draw(poseStack, Component.translatable("gui.swordverse_online.social.label_party"), 15, -54, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.swordverse_online.social.label_friends"), 15, -36, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.swordverse_online.social.label_guild"), 15, -18, -12829636);
	}
	...
	public void init() {
		...
		imagebutton_party_button = new ImageButton(this.leftPos + -2, this.topPos + -59, 82, 18, 0, 0, 18, new ResourceLocation("swordverse_online:textures/screens/atlas/imagebutton_party_button.png"), 82, 36, e -> {
		});
		guistate.put("button:imagebutton_party_button", imagebutton_party_button);
		this.addRenderableWidget(imagebutton_party_button);
		imagebutton_friends_button = new ImageButton(this.leftPos + -2, this.topPos + -41, 82, 18, 0, 0, 18, new ResourceLocation("swordverse_online:textures/screens/atlas/imagebutton_friends_button.png"), 82, 36, e -> {
		});
		guistate.put("button:imagebutton_friends_button", imagebutton_friends_button);
		this.addRenderableWidget(imagebutton_friends_button);
		imagebutton_guild_button = new ImageButton(this.leftPos + -2, this.topPos + -23, 82, 18, 0, 0, 18, new ResourceLocation("swordverse_online:textures/screens/atlas/imagebutton_guild_button.png"), 82, 36, e -> {
		});
		guistate.put("button:imagebutton_guild_button", imagebutton_guild_button);
		this.addRenderableWidget(imagebutton_guild_button);
	}
}
