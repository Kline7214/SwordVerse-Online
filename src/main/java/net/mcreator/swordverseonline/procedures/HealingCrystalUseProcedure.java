...
public class HealingCrystalUseProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == SwordverseOnlineModItems.HEALING_CRYSTAL.get()) {
			...
			if (entity instanceof Player _player) {
				ItemStack _stktoremove = new ItemStack(SwordverseOnlineModItems.HEALING_CRYSTAL.get());
